...
resin = resin_data %>% 
  ...
  group_by(date, plot, installed) %>% 
  summarise(nh4_ugN.day_mean = mean(nh4_ugN.day, na.rm = T),
            nh4_ugN.day_SD = sd(nh4_ugN.day, na.rm = T),
            no3_ugN.day_mean = mean(no3_ugN.day, na.rm = T),
            no3_ugN.day_SD = sd(no3_ugN.day, na.rm = T)) %>% 
